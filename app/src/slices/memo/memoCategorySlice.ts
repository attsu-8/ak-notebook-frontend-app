...
export const fetchAsyncGetParentMemoCategories = createAsyncThunk(
  ...
  async () => {
    const res = await axios.get(`${apiUrl}api/parent-memo-category/`, {
      headers: {
...
export const fetchAsyncGetParentMemoCategoriesFilter = createAsyncThunk(
  ...
  async (noteId: string) => {
    const res = await axios.get(`${apiUrl}api/filter/parent-memo-category/?note=${noteId}`, {
      headers: {
        Authorization: `JWT ${localStorage.accessToken}`,
      },
    });
...
export const fetchAsyncGetChildMemoCategories = createAsyncThunk(
  ...
  async () => {
    const res = await axios.get(`${apiUrl}api/child-memo-category/`, {
      headers: {
        Authorization: `JWT ${localStorage.accessToken}`,
      },
    });
...
export const fetchAsyncCreateParentMemoCategory = createAsyncThunk(
  ...
  async (parentMemoCategory: ParentMemoCategoryProps) => {
    const res = await axios.post(`${apiUrl}api/parent-memo-category/`, parentMemoCategory, {
      headers: {
...
export const fetchAsyncCreateChildMemoCategory = createAsyncThunk(
  ...
  async (childMemoCategory: ChildMemoCategoryProps) => {
    const res = await axios.post(`${apiUrl}api/child-memo-category/`, childMemoCategory, {
      headers: {
        'Content-Type': 'application/json',
        Authorization: `JWT ${localStorage.accessToken}`,
      },
...
export const memoCategorySlice = createSlice({
  ...
  reducers: {
    ...
    resetSelectParentMemoCategory(state) {
      state.selectMemoCategory.parentMemoCategory =
        initialState.selectMemoCategory.parentMemoCategory;
    },
    ...
    resetSelectChildMemoCategory(state) {
      state.selectMemoCategory.childMemoCategory =
        initialState.selectMemoCategory.childMemoCategory;
    },
    resetParentMemoCategoryOptions(state) {
      state.memoCategoryOptions.parentMemoCategories =
        initialState.memoCategoryOptions.parentMemoCategories;
    },
    resetChildMemoCategoryOptions(state) {
      state.memoCategoryOptions.childMemoCategories =
        initialState.memoCategoryOptions.childMemoCategories;
    },
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchAsyncGetParentMemoCategoriesFilter.fulfilled, (state, action) => {
      state.memoCategoryOptions.parentMemoCategories = action.payload;
    });
    builder.addCase(fetchAsyncGetChildMemoCategoriesFilter.fulfilled, (state, action) => {
      state.memoCategoryOptions.childMemoCategories = action.payload;
    });
    builder.addCase(fetchAsyncCreateParentMemoCategory.fulfilled, (state, action) => {
      state.selectMemoCategory.parentMemoCategory = action.payload;
      state.memoCategoryOptions.parentMemoCategories = [
        ...state.memoCategoryOptions.parentMemoCategories,
        action.payload,
    ...
    builder.addCase(fetchAsyncCreateChildMemoCategory.fulfilled, (state, action) => {
      state.selectMemoCategory.childMemoCategory = action.payload;
      state.memoCategoryOptions.childMemoCategories = [
        ...state.memoCategoryOptions.childMemoCategories,
        action.payload,
    ...
    builder.addCase(fetchAsyncPatchParentMemoCategory.fulfilled, (state, action) => {
      if (
        state.selectMemoCategory.parentMemoCategory.memoCategoryId === action.payload.memoCategoryId
      ) {
        state.selectMemoCategory.parentMemoCategory = action.payload;
      }
      state.memoCategoryOptions.parentMemoCategories =
        state.memoCategoryOptions.parentMemoCategories.map((parentMemoCategory) =>
          parentMemoCategory.memoCategoryId === action.payload.memoCategoryId
            ? action.payload
            : parentMemoCategory,
        );
    });
    builder.addCase(fetchAsyncPatchChildMemoCategory.fulfilled, (state, action) => {
      if (
        state.selectMemoCategory.childMemoCategory.memoCategoryId === action.payload.memoCategoryId
      ) {
        state.selectMemoCategory.childMemoCategory = action.payload;
      }
      state.memoCategoryOptions.childMemoCategories =
        state.memoCategoryOptions.childMemoCategories.map((childMemoCategory) =>
          childMemoCategory.memoCategoryId === action.payload.memoCategoryId
            ? action.payload
            : childMemoCategory,
        );
    });
    builder.addCase(fetchAsyncLogicalDeleteParentMemoCategory.fulfilled, (state, action) => {
      if (
        state.selectMemoCategory.parentMemoCategory.memoCategoryId === action.payload.memoCategoryId
      ) {
        state.selectMemoCategory.parentMemoCategory =
      ...
      state.memoCategoryOptions.parentMemoCategories =
        state.memoCategoryOptions.parentMemoCategories.filter((parentMemoCategory) => {
          return parentMemoCategory.memoCategoryId !== action.payload.memoCategoryId;
        });
    });
    builder.addCase(fetchAsyncLogicalDeleteChildMemoCategory.fulfilled, (state, action) => {
      if (
        state.selectMemoCategory.childMemoCategory.memoCategoryId === action.payload.memoCategoryId
      ) {
        state.selectMemoCategory.childMemoCategory =
      ...
      state.memoCategoryOptions.childMemoCategories =
        state.memoCategoryOptions.childMemoCategories.filter((childMemoCategory) => {
...
export const selectSelectParentMemoCategory = (state: RootState) =>
  state.memoCategory.selectMemoCategory.parentMemoCategory;
export const selectSelectChildMemoCategory = (state: RootState) =>
  state.memoCategory.selectMemoCategory.childMemoCategory;
export const selectParentMemoCategoryOptions = (state: RootState) =>
  state.memoCategory.memoCategoryOptions.parentMemoCategories;
export const selectChildMemoCategoryOptions = (state: RootState) =>
  state.memoCategory.memoCategoryOptions.childMemoCategories;
export const selectIsParentMemoCategoryNewEditorOpen = (state: RootState) =>
  state.memoCategory.isParentMemoCategoryNewEditorOpen;
export const selectIsChildMemoCategoryNewEditorOpen = (state: RootState) =>
  state.memoCategory.isChildMemoCategoryNewEditorOpen;
export const selectIsCreatedChildMemoCategory = (state: RootState) =>
  state.memoCategory.isCreatedChildMemoCategory;
