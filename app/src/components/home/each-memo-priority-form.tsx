...
export const PriorityForm: VFC = () => {
    ...
    const PriorityCheckbox: VFC<PriorityCheckboxProps> = (props) => {
        ...
        return (
            <FormControlLabel
                control={
                <Checkbox checked={priorityChecked} onChange={handleChange} name={priorityName} />
                }
                label={
                    <Rating 
                        name={priorityName}
    ...
    return (
        <FormControl component="fieldset" variant="standard">
            <FormGroup>
                <PriorityCheckbox
                    priorityName={"priority5"}
                    priorityChecked={priority5}
                    priority={5}
                />
                <PriorityCheckbox
                    priorityName={"priority4"}
                    priorityChecked={priority4}
                    priority={4}
                />
                <PriorityCheckbox
                    priorityName={"priority3"}
                    priorityChecked={priority3}
                    priority={3}
                />
                <PriorityCheckbox
                    priorityName={"priority2"}
                    priorityChecked={priority2}
                    priority={2}
                />
                <PriorityCheckbox
                    priorityName={"priority1"}
                    priorityChecked={priority1}
                    priority={1}
                />
            </FormGroup>
        </FormControl>
