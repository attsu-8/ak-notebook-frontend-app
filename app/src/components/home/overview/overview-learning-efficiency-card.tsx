...
export const OverviewLearningEfficiencyCard: VFC<OverviewLearningEfficiencyCardProps> = (props) => {
  const {
    ...
    yesterdayLearningEfficiencyRate,
    todayLearningEfficiencyRateColor,
    ...other
  } = props;
  const learningEfficiencyRateOfIncrease =
    Math.round((todayLearningEfficiencyRate - yesterdayLearningEfficiencyRate) * 10) / 10;
  ...
  return (
    ...
    >
      ...
      >
        {todayLearningEfficiencyRate && <Doughnut data={chartData} options={chartOptions} />}
      </Box>
      ...
      >
        ...
        <Box>
          <Typography color={todayLearningEfficiencyRateColor} variant='h4'>
            {`${todayLearningEfficiencyRate}%`}
          </Typography>
        </Box>
      </Box>
