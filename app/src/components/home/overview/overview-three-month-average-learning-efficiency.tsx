...
import {
  selectThreeMonthAverageLearningEfficiencyRateToday,
  selectThreeMonthAverageLearningEfficiencyRateYesterday,
...
export const OverviewThreeMonthAverageLearningEfficiency: VFC = () => {
  const threeMonthAverageLearningEfficiencyRateToday = useSelector(
    selectThreeMonthAverageLearningEfficiencyRateToday,
  );
  const threeMonthAverageLearningEfficiencyRateYesterday = useSelector(
    selectThreeMonthAverageLearningEfficiencyRateYesterday,
  );
    ...
    datasets: [
      {
        ...
        data: [
          ...
          100 - threeMonthAverageLearningEfficiencyRateToday,
        ],
        backgroundColor: [theme.palette.secondary.main, alpha(theme.palette.secondary.main, 0.08)],
