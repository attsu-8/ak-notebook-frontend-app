...
import {
  ...
  selectYesterdayLearningEfficiencyRate,
    ...
    datasets: [
      {
        ...
        backgroundColor: [theme.palette.primary.main, alpha(theme.palette.primary.main, 0.08)],
        borderColor: ['rgba(255, 255, 255, 0)', 'rgba(255, 255, 255, 0)'],
        hoverBackgroundColor: [theme.palette.primary.main, alpha(theme.palette.primary.main, 0.08)],
      },
    ],
  };
