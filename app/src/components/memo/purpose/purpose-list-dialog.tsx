...
import {
  changeEditPurpose,
  fetchAsyncCreatePurpose,
  fetchAsyncLogicalDeletePurpose,
  fetchAsyncPatchPurpose,
  resetEditPurpose,
  selectPurposeOptions,
} from '../../../slices/memo/purposeSlice';
  ...
  return (
    <>
      <MemoDialog
        ...
        headerTitle='目的エディタ'
        footerButton={
          <MemoAddButton toolTipTitle='目的追加' onClickAction={() => newButtonClick()}>
            追加
          </MemoAddButton>
        }
      >
      ...
      <PurposeEditorDialog
        ...
        footerButton={<NewPurposeButton formId={newPurposeEditor} />}
      ...
      <PurposeEditorDialog
        ...
        footerButton={<UpdatePurposeButton formId={editPurposeEditor} />}
      ...
      <PurposeDeleteDialog
        ...
        footerButton={<DeletePurposeButton formId={editPurposeEditor} onClick={onClickDelete} />}
        formId={editPurposeEditor}
      />
    </>
  );
