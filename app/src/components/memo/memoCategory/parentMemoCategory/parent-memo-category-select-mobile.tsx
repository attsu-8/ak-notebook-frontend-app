...
import { selectParentMemoCategoryOptions, fetchAsyncGetChildMemoCategoriesFilter, changeSelectParentMemoCategory,  selectSelectParentMemoCategory, resetSelectChildMemoCategory} from "../../../../slices/memo/memoCategorySlice";
...
export const ParentMemoCategorySelectMobile:VFC = () => {
    ...
    return (
        <FormControl fullWidth>
            <InputLabel id="parent-memo-category-select-label">
                親カテゴリ
            </InputLabel>
            <Select
                size="small"
