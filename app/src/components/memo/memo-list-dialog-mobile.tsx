...
export const MemoListDialogMobile: VFC<MemoListDialogMobileProps> = (props) => {
  ...
  const [isOpenParentMemoCategoryListDialog, setIsOpenParentMemoCategoryListDialog] =
    useState<boolean>(false);
  const [isOpenChildMemoCategoryListDialog, setIsOpenChildMemoCategoryListDialog] =
    useState<boolean>(false);
  ...
  return (
    <>
      <MemoDialog isOpen={isOpen} onClose={onClose} headerTitle='選択リスト'>
        <List
          sx={{
          ...
          >
            <Box sx={{ width: '10%' }}>
              {selectParentMemoCategory.memoCategoryIcon ? (
                <MemoEmojiIcon emojiId={selectParentMemoCategory.memoCategoryIcon} emojiSize={35} />
              ) : (
          ...
          >
            <Box sx={{ width: '10%' }}>
              {selectChildMemoCategory.memoCategoryIcon ? (
                <MemoEmojiIcon emojiId={selectChildMemoCategory.memoCategoryIcon} emojiSize={35} />
              ) : (
                <MemoCategoryIcon fontSize='large' />
              )}
            </Box>
      ...
      <NoteListDialog isOpen={isOpenNoteListDialog} onClose={setIsOpenNoteListDialog} />
